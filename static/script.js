...
// Function to convert text to SiGML and send it to JASigning
function convertAndPlay() {
    ...
    const jasigningFrame = document.getElementById("jasigning-frame");
    const sigmlUrl = `https://vhg.cmp.uea.ac.uk/jasigning/?sigmltext=${encodeURIComponent(text)}`;
    jasigningFrame.src = sigmlUrl;
    console.log("Sending text to JASigning:", text);
}
